    ...
    return (
        <View style={homeStyles.containerUserHome}>
            <View style={homeStyles.userInfoLevel}>
                ...
                <Text style={homeStyles.userInfo}>{user.pais}</Text>
                <View style={homeStyles.containerLocationUser}>
                    <Text style={homeStyles.userInfo}>{user.provincia !== null && user.provincia}</Text>
                    <Text style={homeStyles.userInfo}>{user.municipio !== null && - user.municipio}</Text>
                </View>
