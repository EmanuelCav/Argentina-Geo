...
router.post('/questions/category/:id', [auth, validRole], upload.single("file"), validQuestion, questionsCtrl.createQuestions)
...
router.patch('/questions/:qid/category/:cid', [auth, validRole], questionsCtrl.updateCategory)
