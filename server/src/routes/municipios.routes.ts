...
import validMunicipio from '../middleware/validation/location/validMunicipio';
...
router.post('/municipios', [auth, validRole], validMunicipio, upload.array("files", 10), municipiosCtrl.createMunicipio)
